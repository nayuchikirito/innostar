...
<script src="{{ url('http://momentjs.com/downloads/moment.js') }}"></script>
<script src="{{ url('https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.8.0/fullcalendar.min.js') }}""></script>
