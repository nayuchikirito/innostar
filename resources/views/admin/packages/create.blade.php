<div class="modal-dialog modal-lg add-package-form">
  <div class="modal-content">
    ...
    <form action="{{ url('/admin/packages') }}" method="POST" id="add-packages-form">
    {{ csrf_field() }}
    <div class="modal-body">
      ...
      <div class="form-group">
          ...
          <input type="text" class="form-control" id="price" name="price" placeholder="Enter Price" autocomplete="false">
          <span class="help-text text-danger"></span>
      </div>
      <div class="form-group">
          <label for="description">Description</label>
          <textarea type="text" class="form-control" id="description" name="description" placeholder="Enter Description" autocomplete="false"></textarea>
          <span class="help-text text-danger"></span>
      </div>
    </div>
