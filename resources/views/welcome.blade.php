      ...
      <div class="container my-auto">
        <div class="row">
          ...
          <div class="col-lg-8 mx-auto">
            <p class="white-text mb-5 ">Events Coordinating and Planning Team.<br>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              ...
              <p class="text-muted mb-0 ">Manage and monitor events. Keep track of client's requests.</p>
              <hr>
          ...
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              ...
              <p class="text-muted mb-0 ">Manage and monitor events. Handle reservation requests.</p>
              <hr>
              <a class="btn btn-light btn-xl sr-button" href="/login">Login</a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              ...
              <p class="text-muted mb-0 ">View handled reservations. Manage requests.</p>
              <hr>
              <a class="btn btn-light btn-xl sr-button"  href="/login">Login</a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 text-center">
            <div class="service-box mt-5 mx-auto">
              ...
              <p class="text-muted mb-0 ">Manage reservations.</p>
              <hr>
              <a class="btn btn-light btn-xl sr-button"  href="/login">Login</a>
